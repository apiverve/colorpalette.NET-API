...
namespace APIVerve
{
    public class ColorPaletteGeneratorAPIClient
    {
        ...
        public ColorPaletteGeneratorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public ColorPaletteGeneratorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, colorpaletteQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(colorpaletteQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(colorpaletteQueryOptions options)
        {
